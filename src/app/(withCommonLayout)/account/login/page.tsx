    ...
    return (
      ...
      <div className='Container py-40'>
         <div className='flex items-center justify-center flex-col gap-2'>
            ...
            <p className='text-gray-600'>If you have an account with us, please log in.</p>
         </div>
         ...
         <div className='xl:px-80 lg:px-60 md:px-40 mt-8'>
            <form className='flex flex-col gap-4'>
                ...
                <div className='flex items-center justify-center flex-col'>
                    <p className='font-medium'>Don t have an account? <Link href="/account/register" className='text-sm text-gray-500 underline hover:text-[#AC0000] duration-300 cursor-pointer'>Create an account</Link></p>
                    
                    {/* <p className='text-sm text-gray-500 underline hover:text-[#AC0000] duration-300 cursor-pointer'>Forgot your password?</p> */}
