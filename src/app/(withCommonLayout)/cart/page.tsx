      ...
      <div className="Container w-full mx-auto xl:px-40 lg:px-15 md:px-20 mt-16">
        ...
        <div className="flex flex-col gap-8 justify-between items-center my-12">
          <div className="text-xl font-medium flex items-center gap-2">
            ...
            <span className="text-2xl  text-primary">8320</span>
          </div>

          <Link href="/checkout" className="w-[70%] sm:w-[50%] md:w-[40%]">
            <div className="text-white text-sm font-medium items-center text-center  bg-primary  hover:bg-[#AC0000] cursor-pointer duration-300 px-2 py-2">
          ...
          <Link
            href="/shop"
            className="text-white text-sm font-semimedium  items-center text-center w-[70%] sm:w-[50%] md:w-[40%] bg-primary hover:bg-[#AC0000] px-2 py-2 mt-3 duration-300"
          >
