      ...
      <div className="Container py-6 mt-12">
        <div className="flex flex-col gap-2 lg:gap-4">
          ...
          <div className="policy-page-text ">
            ...
            the services provided by zarganz.com you agree to the collection
            and use of your data by zarganz.com in the manner provided in this
            Privacy Policy.
          </div>
          ...
          <div className="">
            ...
            <ul className="policy-page-text policy-page-li">
              ...
              <li>
                ...
                safety or security of any person, violations of zarganz.com s
          ...
          <div className="policy-page-text">
            ...
            you at any stage want to delete your personal data from zarganz,
            across all platforms, you have the full right to do so. Please send
            an email to support@zarganz.com, we will process your request
